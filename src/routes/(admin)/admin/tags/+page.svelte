            ...
            >
                <div class="form-group">
                    ...
                    <input
                            ...
                            value={newTagName}
                            on:change={(e) => newTagName = e.currentTarget.value}
                            required
                    />
                </div>
                                ...
                                >
                                    ...
                                    <div class="edit-controls">
                                        <input
                                                ...
                                                name="name"
                                                value={editTagName}
                                                on:change={(e) => editTagName = e.currentTarget.value}
                                                required
                                        />
                                        <button
                                                type="submit"
                            ...
                            {:else}
                                <div class="tag-actions">
                                    <button
                                            type="button"
                                            class="edit-btn"
                                            on:click={() => startEdit(tag.id, tag.name)}
                                    >
                                        Edit
                                    </button>
                                    <ConfirmDelete
                                            ...
                                            buttonLabel="Delete"
                                            buttonTitle={tag._count.posts > 0 ? "Cannot delete tag with posts" : "Delete tag"}
