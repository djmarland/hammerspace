...
<SiteTemplate>
    ...
    <div class="piko-prose">
        <section class="piko-prose__block" id="core">
            <h2>Core</h2>
            <p>The Core section sets up CSS custom properties for core design tokens, used throughout the design system.
                They aren't often used directly in components, but are the foundation for semantic tokens and component
                styles.
            </p>
            <section id="core-colours" class="piko-prose__block">
                <h3>Colour Palette</h3>
                <p>
                    The base colours used in the design system. These are used to generate semantic colours for
                    components and states.
                    Dynamic is a special palette that is generated from today's hue.
                </p>
                <div class="piko-prose__block hue-control">
                    <label for="piko-dynamic-hue">Today's hue: <span class="hue-demo">{dynamicHue}</span></label>
                    <input
                            id="piko-dynamic-hue"
                            type="range"
                            min="0"
            ...
            <section id="core-font">
                <h3>Font</h3>
                <p>The text scaling system comes from <a
                        href="https://utopia.fyi/type/calculator?c=360,16,1.2,1240,20,1.25,5,2,&s=0.75|0.5|0.25,1.5|2|3|4|6,s-l&g=s,l,xl,12"
                        target="_blank" rel="noopener noreferrer">Utopia</a> making it dyanmic at different viewports
                    sizes.</p>
                <table>
                    <thead>
                    <tr>
        ...
        <section class="piko-docs-section piko-prose" id="semantic">
            ...
            <p>Semantic tokens and classes are the implementable versions of the core design tokens. They take into
                account dark/light mode and are about the intended <em>use</em> of the token rather than its raw value.
                Core tokens generally never change their value, but semantic tokens may - and that change will cascade
                through the website.</p>

            <section id="semantic-colours">
                <h3>Colours</h3>
                <p>These are colours with meaning, so should always be used instead of the core palette tokens.</p>
            ...
            <section id="semantic-typography">
                <h3>Typography</h3>
                <p>These are classes to use for typography, which will apply the appropriate font-size, line-height,
                    font-weight and letter-spacing.</p>
                <table>
                    <thead>
                    <tr>
                        <th>Classname</th>
        ...
        <section class="piko-docs-section" id="html-kitchen-sink">
            ...
            <dl>
                ...
                <dd>
                    Defintion List Description. A definition list is perfect for defining terms, and is a great way to
                    display metadata.
                </dd>
